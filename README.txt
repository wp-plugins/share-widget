...
Tags: share-widget, sharewidget, share, email, e-mail, bookmark, social, network, link, xnu, x.nu, sharing
...
- Selecting 'Short & Share' your URL will be shorted automatically using the X.nu service

== Installation ==
1. Download the plugin archive and expand it.
2. Upload the 'share-widget.php' file into your wp-content/plugins/ directory.
3. Go to the Plugins page in your WordPress Admini area and activate Share-Widget.
...
Share-Widget can also work without Javascript but you can have the best from this widget with Javascript enabled.

= What the service X.nu is? =
X.NU is a service to create short URLs. Visit on http://www.x.nu 
